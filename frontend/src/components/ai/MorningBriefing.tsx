  ...
  return (
    <div className="space-y-3 py-2">
      {[1, 2, 3, 4, 5, 6].map((i) => (
        <div
          key={i}
          className="ai-skeleton h-4 rounded"
          style={{
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium
                         bg-ai-blue/10 text-ai-blue hover:bg-ai-blue/20 transition-colors
        ...
        {error && (
          <div className="flex items-center gap-2 py-4 px-4 rounded-lg border border-loss/30 bg-loss/5">
            ...
            <button
              ...
              className="text-sm text-loss underline hover:text-loss/80"
            >
              retry
            </button>
          </div>
